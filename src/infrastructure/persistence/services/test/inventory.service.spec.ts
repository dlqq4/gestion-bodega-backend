...
describe('InventoryService', () => {
    ...
    describe('findAll', () => {
        it('should return an array of InventoryMongos', async () => {
            ...
            //jest.spyOn(inventoryMongoModel, 'find').mockResolvedValue(mockInventoryMongos as any);
            ...
            expect(await lastValueFrom(result)).toEqual(mockInventoryMongos);
        });
    });
