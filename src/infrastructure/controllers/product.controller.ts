...
export class ProductController {
    ...
    @Post('create-product')
    create(@Body() product: ProductDto): Observable<ProductEntityInfra> {
    ...
    @Put('update-product')
    update(@Body() id: string, @Body() product: ProductDto): Observable<ProductEntityInfra> {
    ...
    findAll(): Observable<ProductEntityInfra[]> {
